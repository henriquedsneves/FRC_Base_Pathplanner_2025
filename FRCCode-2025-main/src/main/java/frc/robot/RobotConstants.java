...
public final class RobotConstants {
        public static final class DrivetrainConstants {
                public static final double FRONT_LEFT_VIRTUAL_OFFSET_RADIANS = 1000;
                public static final double FRONT_RIGHT_VIRTUAL_OFFSET_RADIANS = 39764; // -We do not apply an offset to the
                                                                                   // CANcoder
                                                                                   // angle, we just zero the encoders
                                                                                   // with the
                                                                                   // wheels forward
                                                                                   // -In radians
                public static final double REAR_LEFT_VIRTUAL_OFFSET_RADIANS = 28983;
                public static final double REAR_RIGHT_VIRTUAL_OFFSET_RADIANS = 1888;
...
//Possível problema na hora de pegar o offset, não acontece a leitura;